...
const checkEyeColor = (users) => {
  ...
  users.forEach((user) => {
    ...
    if (user.eyeColor === "blue") {
      // masukkan data dari users ke dalam array kosong yang sudah dibuat
...
// panggil variabel checkeyecolor dengan parameter users untuk mengecek data dari users
console.log(`total: ${checkEyeColor(users).total}`);
console.log(checkEyeColor(users).users);
